// src/pages/Reward/WheelOfFortuneReward.jsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-yellow-950/20 to-black p-4 text-white lg:p-6">
      <div className="mx-auto max-w-[1500px]">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="h-11 w-full cursor-pointer rounded-xl border border-yellow-700/50 bg-black/70 px-3 text-sm outline-none"
                >
          ...
          <Section title="Spin Conditions" icon={<FaSyncAlt />}>
            <p className="mb-4 text-xs text-yellow-100/50">
          ...
          <div className="mb-10 flex flex-wrap gap-4">
            <button
              type="submit"
              disabled={saving}
              className={`flex items-center gap-2 rounded-xl px-8 py-3.5 font-bold ${
                saving
            ...
            {editingId && (
              <button
                type="button"
                onClick={resetForm}
                className="cursor-pointer rounded-xl border border-yellow-700/50 bg-black/70 px-8 py-3.5 font-bold text-yellow-200"
              >
                Cancel Edit
              </button>
            )}
        ...
        <div>
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <h2 className="text-2xl font-bold text-yellow-300">All Wheels</h2>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <div className="relative">
                <FaSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-yellow-400/50" />

                <input
                  value={search}
                  onChange={(event) => setSearch(event.target.value)}
                  placeholder="Search Wheels..."
                  className="h-11 rounded-xl border border-yellow-700/50 bg-black/70 pl-10 pr-3 text-sm outline-none"
                />
              </div>
              ...
              <select
                ...
                className="h-11 cursor-pointer rounded-xl border border-yellow-700/50 bg-black/70 px-3 text-sm"
              >
          ...
          {pagination.totalPages > 1 && (
            <div className="mt-6 flex justify-center gap-2">
              <button
                ...
                className="cursor-pointer rounded-lg bg-yellow-500 px-4 py-2 font-bold text-black disabled:cursor-not-allowed disabled:opacity-40"
              >
                Previous
              </button>

              <span className="rounded-lg bg-black/60 px-4 py-2 text-yellow-300">
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/75 p-4">
          <div className="w-full max-w-sm rounded-2xl border border-yellow-700/50 bg-[#17120a] p-6">
            <h3 className="text-xl font-bold text-yellow-300">Delete Wheel?</h3>
...
const Section = ({ title, icon, children }) => (
  <section className="mb-6 rounded-2xl border border-yellow-700/40 bg-black/55 p-5 shadow-xl">
    <h2 className="mb-5 flex items-center gap-2 text-lg font-bold text-yellow-300">
      {icon}
      {title}
    </h2>
...
const Label = ({ children }) => (
  <label className="mb-2 block text-xs font-bold text-yellow-100/70">
    {children}
  </label>
);
...
const Input = ({ label, value, onChange }) => (
  <div>
    ...
    <input
      ...
      className="h-11 w-full rounded-xl border border-yellow-700/50 bg-black/70 px-3 text-sm outline-none focus:border-yellow-400"
    />
  </div>
);
...
const NumberInput = ({
  ...
  <div>
    ...
    <input
      ...
      disabled={disabled}
      onChange={(event) => onChange(event.target.value)}
      className="h-11 w-full rounded-xl border border-yellow-700/50 bg-black/70 px-3 text-sm outline-none focus:border-yellow-400 disabled:cursor-not-allowed disabled:opacity-40"
    />
  </div>
);
...
const TextArea = ({ label, value, onChange }) => (
  <div>
    ...
    <textarea
      ...
      rows={4}
      onChange={(event) => onChange(event.target.value)}
      className="w-full resize-none rounded-xl border border-yellow-700/50 bg-black/70 p-3 text-sm outline-none focus:border-yellow-400"
    />
  </div>
);
...
const ImageUpload = ({ label, description, preview, onChange, required }) => (
  <div>
    ...
    <input
      ...
      accept="image/*"
      onChange={onChange}
      className="w-full cursor-pointer rounded-xl border border-yellow-700/50 bg-black/70 px-4 py-3 text-sm file:mr-3 file:cursor-pointer file:rounded-lg file:border-0 file:bg-yellow-500 file:px-4 file:py-2 file:font-bold file:text-black"
    />

    <p className="mt-2 text-[11px] text-yellow-100/45">{description}</p>

    {preview && (
      <img
        src={preview}
        alt={label}
        className="mt-4 h-52 w-full rounded-xl border border-yellow-700/40 object-cover"
      />
    )}
  </div>
);
...
const SegmentEditor = ({ index, segment, onChange }) => (
  <div className="rounded-xl border border-yellow-700/40 bg-black/40 p-4">
    <div className="mb-4 flex items-center justify-between">
      <h3 className="font-bold text-yellow-300">Segment {index + 1}</h3>
    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      ...
      <div>
        ...
        <select
          ...
          className="h-11 w-full cursor-pointer rounded-xl border border-yellow-700/50 bg-black/70 px-3 text-sm"
        >
...
const WheelCard = ({
  ...
  <div className="overflow-hidden rounded-2xl border border-yellow-700/40 bg-black/60 shadow-xl">
    ...
    <div className="p-5">
      ...
      <div className="mt-5 flex gap-2">
        <button
          type="button"
          onClick={onEdit}
          className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg bg-yellow-500 px-3 py-2 text-xs font-bold text-black"
        >
          <FaEdit />
          Edit
        </button>
...
const Info = ({ label, value }) => (
  <div className="rounded-lg bg-white/5 p-2">
    ...
    <p className="mt-1 truncate text-[10px] font-bold text-yellow-100/75">
      {value}
    </p>
  </div>
);
