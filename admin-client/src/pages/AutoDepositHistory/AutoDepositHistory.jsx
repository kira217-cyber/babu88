...
const FieldRow = ({ k, v }) => (
  <div className="flex items-start justify-between gap-4 py-2 border-b border-yellow-700/20">
...
const AutoDepositHistory = () => {
  ...
  const fetchData = async ({ page: p = page, limit: l = limit } = {}) => {
    try {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-white/85">
                  All OraclePay auto deposits (admin view)
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_220px_220px] gap-3">
            <form onSubmit={onSearch} className="relative">
              ...
              <input
                ...
                placeholder="Search: username / phone / invoice / transactionId"
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                value={limit}
                onChange={(e) =>
                  fetchData({ page: 1, limit: Number(e.target.value || 20) })
                }
                className="w-full py-3 px-3 rounded-xl bg-black/50 border border-yellow-700/50 text-white outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/30"
              >
                        ...
                        {isExpanded && (
                          <tr>
                            <td colSpan={6} className="p-0 bg-black/40">
                              <div className="p-5 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
                                {/* Column 1 */}
                                <div className="rounded-2xl border border-yellow-700/40 bg-black/35 p-4">
                                  ...
                                  />
                                  <FieldRow k="Amount" v={money(item.amount)} />
