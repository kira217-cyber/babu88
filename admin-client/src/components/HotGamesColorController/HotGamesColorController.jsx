...
const PreviewCard = ({ form }) => {
  const previewImg = test;

  return (
    <div className="sticky top-5">
      <h3 className={sectionTitleCls}>Live Preview</h3>

      <div className="rounded-2xl border border-yellow-900/30 bg-black/50 p-5">
        <h2
        ...
        <div className="group w-48">
          <button
            ...
            style={{
              ...
              backgroundColor: hexToRgba(form.cardBg, form.cardBgOpacity),
              boxShadow: String(form.cardShadow || "").replaceAll("_", " "),
              border: `${form.cardBorderWidth}px solid ${form.cardBorderColor}`,
            }}
          >
            ...
            <style>{`
              .group:hover img { transform: scale(${form.imgHoverScale}); }
            `}</style>
            ...
            <div
              ...
              style={{
                backgroundColor: hexToRgba(form.overlayBg, form.overlayOpacity),
              }}
            >
              <div
                ...
                style={{
                  backgroundColor: hexToRgba(
                    form.playPillBg,
                    form.playPillBgOpacity,
                  ),
                  borderColor: hexToRgba(
                    form.playPillBorder,
                    form.playPillBorderOpacity,
                  ),
                  color: form.playTextColor,
                  fontWeight: form.playTextWeight,
                  fontSize: form.playTextSize,
                }}
              >
                PLAY
              </div>
          ...
          <div className="mt-2">
            <p
              ...
              style={{
                backgroundColor: form.gameTitleBg,
                color: form.gameTitleText,
                fontSize: form.gameTitleSize,
                fontWeight: form.gameTitleWeight,
              }}
            >
              Fortune Tiger
            </p>
            ...
            <p
              ...
              style={{
                backgroundColor: hexToRgba(
                  form.providerBg,
                  form.providerBgOpacity,
                ),
                color: hexToRgba(form.providerText, form.providerOpacity),
                fontSize: form.providerSize,
                fontWeight: form.providerWeight,
              }}
            >
              PG SOFT
            </p>
        ...
        <p className="mt-5 text-xs text-yellow-100/50">
          Hover the preview card to check overlay and PLAY button color.
        </p>
      </div>
    </div>
  );
              ...
              <div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                  ...
                  <ColorField
                    ...
                    onChange={(v) => setVal("cardBorderColor", v)}
                  />
                  <IntField
                    label="Card Border Width (px)"
                    value={form.cardBorderWidth}
                    onChange={(v) => setVal("cardBorderWidth", v)}
                    min={0}
                    max={10}
                  />
                  <NumField
              ...
              <div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                  ...
                  <ColorField
                    ...
                    value={form.providerBg}
                    onChange={(v) => setVal("providerBg", v)}
                  />
                  <NumField
                    label="Provider BG Opacity"
                    value={form.providerBgOpacity}
                    onChange={(v) => setVal("providerBgOpacity", v)}
                  />
                  <ColorField
