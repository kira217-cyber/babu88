...
const normalizeWheelData = (req, existingWheel = null) => {
  ...
  /**
   * Multer upload.fields() ব্যবহার করায়
   * image পাওয়া যাবে req.files থেকে।
   */
  ...
  /**
   * Update-এর সময় নতুন background image না দিলে
   * পুরোনো background image রাখা হবে।
   */
  ...
  /**
   * Update-এর সময় নতুন wheel image না দিলে
   * পুরোনো wheel image রাখা হবে।
   */
