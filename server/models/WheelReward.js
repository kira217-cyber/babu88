...
const WheelRewardSchema = new Schema(
  {
    /**
     * সম্পূর্ণ Wheel page-এর background image।
     * Multer field name: backgroundImage
     *
     * Example:
     * /uploads/wheel-background.jpg
     */
    backgroundImage: {
      type: String,
      required: true,
    ...
    /**
     * Wheel selection/card-এ প্রদর্শিত image।
     * Multer field name: wheelImage
     *
     * Example:
     * /uploads/wheel-image.png
     */
    wheelImage: {
      type: String,
      required: true,
...
const WheelReward = mongoose.model("WheelReward", WheelRewardSchema);
